...
const fusionSaveHandler = async (pathology_num, fusion, report_gb ) => {
	...
	let seq               = fusion.seq;
	let readcount 		  = nvl(fusion.readcount, '');
...
const  messageHandler = async (pathology_num, patientinfo, mutation_c, amplification_c, fusion_c,
  ...
  //입력 파라미터를 수신한다
  logger.info("[406->][pathResearchReportInsert]pathology_num=" + pathology_num);
  logger.info("[406->][pathResearchReportInsert]patient_info=" + JSON.stringify(patientinfo));
  logger.info("[406->][pathResearchReportInsert]extraction=" + JSON.stringify(extraction));
  logger.info("[406->][pathResearchReportInsert]mutation_c=" + JSON.stringify(mutation_c));
  logger.info("[406->][pathResearchReportInsert]amplication_c=" + JSON.stringify(amplification_c));
  logger.info("[406->][pathResearchReportInsert]fusion_c=" + JSON.stringify(fusion_c));
  logger.info("[406->][pathResearchReportInsert]mutation_p=" + JSON.stringify(mutation_p));
  logger.info("[406->][pathResearchReportInsert]amplication_p=" + JSON.stringify(amplification_p));
  logger.info("[406->][pathResearchReportInsert]fusion_p=" + JSON.stringify(fusion_p));
  logger.info("[406->][pathResearchReportInsert][messageHandler] screenstatus= " +  screenstatus);
  logger.info("[406->][pathResearchReportInsert][messageHandler] statecontrol= " +  JSON.stringify(statecontrol));
  ...
  logger.info("[459->][pathResearchReportInsert][extraction][msiscore]" + msiscore);
  logger.info("[459->][pathResearchReportInsert][extraction][tumorburden]" + tumorburden);
  logger.info("[459->][pathResearchReportInsert][extraction][tumorcellpercentage]" + tumorcellpercentage);
  logger.info("[459->][pathResearchReportInsert][patientinfo][examin]" + examin);
  logger.info("[459->][pathResearchReportInsert][patientinfo][recheck]" +  recheck);
  logger.info("[459->][pathResearchReportInsert][patientinfo][screenstatus]" + screenstatus);  
  logger.info("[459->][pathResearchReportInsert][patientinfo][rel_pathology_num]" +  rel_pathology_num);
  logger.info("[459->][pathResearchReportInsert][patientinfo][sendEMRDate]" + sendEMRDate);
  ...
  try {
	  ...
	  logger.error('[518][pathResearchReportInsert][handler]err=' + error.message);
  }
  ...
  */ 
  ...
  console.log("[604][path_comment][specialment]", specialment);
	...
	logger.info('[615][pathResearchReportInsert][comment]ins sql=' + sql_comment);
...
//병리 Pathology 보고서 입력
exports.insertReportPathResearch = (req,res, next) => {

 // console.log ('[515][pathResarchReportInsert][ifusion]', req.body);
  ...
  logger.info("[664->][pathResearchReportInsert][insert]screenstatus=" + screenstatus);
  logger.info("[664->][pathResearchReportInsert][insert]pathology_num=" + pathology_num);
  logger.info("[664->][pathResearchReportInsert][insert]patient_info=" + JSON.stringify(patientinfo));
  logger.info("[664->][pathResearchReportInsert][insert]extraction=" + JSON.stringify(extraction));
  logger.info("[664->][pathResearchReportInsert][insert]mutation_c=" + JSON.stringify(mutation_c));
  logger.info("[664->][pathResearchReportInsert][insert]amplication_c=" + JSON.stringify(amplification_c));
  logger.info("[664->][pathResearchReportInsert][insert]fusion_c=" + JSON.stringify(fusion_c));
  logger.info("[664->][pathResearchReportInsert][insert]mutation_p=" + JSON.stringify(mutation_p));
  logger.info("[664->][pathResearchReportInsert][insert]amplication_p=" + JSON.stringify(amplification_p));
  logger.info("[664->][pathResearchReportInsert][insert]fusion_p=" + JSON.stringify(fusion_p));
  logger.info("[664->][pathResearchReportInsert][insert]statecontrol=" + JSON.stringify(statecontrol));
  ...
  .catch( error => {
	logger.error("[684][pathResearchReportInsert insert]err=" + error.message);
	res.sendStatus(500)
  }); 
...
//병리 Pathology 보고서 2차
exports.updateReportPathResearch = (req,res, next) => {

  logger.info("[693][pathResearchReportInsert][updae]req.body=" + JSON.stringify( req.body));
  ...
  logger.info("[709->][pathResearchReportInsert][update]screenstatus=" + screenstatus);
  logger.info("[709->][pathResearchReportInsert][update]pathology_num=" + pathology_num);
  logger.info("[709->][pathResearchReportInsert][update]patient_info=" + JSON.stringify(patientinfo));
  logger.info("[709->][pathResearchReportInsert][update]extraction=" + JSON.stringify(extraction));
  logger.info("[709->][pathResearchReportInsert][update]mutation_c=" + JSON.stringify(mutation_c));
  logger.info("[709->][pathResearchReportInsert][update]amplication_c=" + JSON.stringify(amplification_c));
  logger.info("[709->][pathResearchReportInsert][update]fusion_c=" + JSON.stringify(fusion_c));
  logger.info("[709->][pathResearchReportInsert][update]mutation_p=" + JSON.stringify(mutation_p));
  logger.info("[709->][pathResearchReportInsert][update]amplication_p=" + JSON.stringify(amplification_p));
  logger.info("[709->][pathResearchReportInsert][update]fusion_p=" + JSON.stringify(fusion_p));
  logger.info("[709->][pathResearchReportInsert][update]statecontrol=" + JSON.stringify(statecontrol));
  ...
  .catch( error  => {
	logger.error("[729->][pathResearchReportInsert][update]err=" + error.message);
      res.sendStatus(500)
  }); 
