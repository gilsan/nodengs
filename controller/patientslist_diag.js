  ...
  logger.info('[196][patientinfo_diag list]qry start=' + start + ' ' + end + ' ' +  patientID + ' ' + specimenNo + ' '  + sheet + ' ' +  status + ' ' + research);
    ...
    if(sheet_1.length > 0 )
    {
        if (sheet_1 == 'AMLALL') {
            ...
            sql = sql +   ` and test_code in ('LPC100', 'LPC101', 'LPC117', 'LPC118',   'LPE115', 'LPE141', 'LPE156', 'LPE194', 'LPE221',
            ...
            'LPE282', 'LPE285', 'LPE287', 'LPE290', 'LPE295', 'LPE302', 'LPE306', 'LPE308', 'LPE310',
            ...
            'LPE414', 'LPE418', 'LPE420', 'LPE428', 'LPE431', 'LPE433', 'LPE436', 'LPE438', 'LPE457', 'LPE460', 'LPE462',
